...
nvcc $1 --compiler-options -O3 -maxrregcount=124 --ptxas-options=-v -m64 -arch sm_13 -o HinesGpu ActiveChannels.o HinesMatrix.o PlatformFunctions.o SynapticChannels.o Connections.o SpikeStatistics.o launchHines.o NeuronInfoWriter.o PerformSimulation.o CpuSimulationControl.o HinesGpu.cu PrepareGpuExecution.cu SynapticComm.cu
