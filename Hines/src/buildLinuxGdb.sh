g++ -I/home/rcamargo/cuda/include/ -c -g SynapticChannels.cpp launchHines.cpp ActiveChannels.cpp HinesMatrix.cpp PlatformFunctions.cpp SynapticChannels.cpp Connections.cpp SpikeStatistics.cpp NeuronInfoWriter.cpp PerformSimulation.cpp CpuSimulationControl.cpp KernelProfiler.cpp 

nvcc $1 -lpthread -g -G --ptxas-options=-v -m64 -arch sm_30 -o HinesGpu ActiveChannels.o HinesMatrix.o PlatformFunctions.o SynapticChannels.o Connections.o SpikeStatistics.o launchHines.o NeuronInfoWriter.o PerformSimulation.o CpuSimulationControl.o KernelProfiler.o HinesGpu.cu GpuSimulationControl.cu SynapticComm.cu 
